<template>
  ...
  >
    <v-row>
      ...
      <v-col cols="11">
        Elija la empresa del sistema CONTPAQi Nóminas que desea vincular a la nueva empresa Fiscal
...
export default defineComponent({
  ...
  props: {
    name: {
      type: String as PropType<'empresaNomina' | 'codigo' | 'curp' | 'rfc' | 'puesto' | string>,
      required: true,
    },
  },
  setup(props, { emit }) {},

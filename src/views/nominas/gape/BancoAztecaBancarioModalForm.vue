                  ...
                  <v-card color="transparent" elevation="0" class="pa-3">
                    <v-row>
                      ...
                      <v-col cols="11">
                        ...
                        dispersión del Banco Azteca Bancario.
                      </v-col>
                    </v-row>
                  </v-card>
                </template>
...
export default defineComponent({
  ...
  props: {
    dialogEvent: String,
    dialogItems: { type: Object as () => Partial<AztecaBancario>, required: true },
    dialogTitle: String,
    dialogView: Boolean,
  },
  setup(props, { emit }) {
    ...
    const validateForm = async () => {
      ...
      if (form.valid) {
        try {
          ...
          dialogPropiedades.value.elementos.tipo_banco = 'bancario'

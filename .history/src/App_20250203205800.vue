<template>
  <v-app>
    <v-app-bar app clipped-left height="60" color="#E6E9F5">
      <v-app-bar-nav-icon class="ml-md-1 ml-lg-1 ml-xl-1" @click.stop="onClickDrawer" />
      <v-toolbar-title>
...
export default defineComponent({
  ...
  setup() {
    ...
    const onClickDrawer = () => {
      clickCount.value = (clickCount.value + 1) % 3 // Ciclo entre 0, 1 y 2
    ...
    return { toggleTheme, drawerParent, railParent, drawerChildren, railChildren, onClickDrawer }
  },
})
</script>
<style>

  ...
  setup() {
    ...
    const getItems = async () => {
      try {
        ...
        item.value = {
          nombre_usuario: 'Dulce Díaz',
          iniciales_usuario: 'DD',
          correo_usuario: 'dulce@gmail.com',
          imagen_usuario: 'https://cdn.vuetifyjs.com/images/john.jpg',
        }
      } catch (error) {

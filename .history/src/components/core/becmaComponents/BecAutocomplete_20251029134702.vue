<template>
  ...
  >
    ...
    <template v-if="$slots.tooltip" v-slot:prepend>
      <v-tooltip location="bottom" max-width="30vw">
        ...
        <!-- slot default para poder contenido más complejo (íconos, checks, etc...) -->
        <template #default>
          <slot name="tooltip" />
        </template>
      </v-tooltip>
...
export default defineComponent({
  ...
  props: {
    ...
    placeholder: {
      type: String,
      default: 'Escriba para buscar o seleccione una opción',
    },
    prependIcon: String,
    rules: {

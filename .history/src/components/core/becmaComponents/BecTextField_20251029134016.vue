  ...
  >
    ...
    <template v-if="tooltip && !$slots.tooltip" v-slot:prepend>
      <div style="pointer-events: auto; cursor: help">
        <v-tooltip location="bottom" max-height="50vw">
    ...
    <template v-if="$slots.tooltip" v-slot:prepend>
      <div style="pointer-events: auto; cursor: help; max-width: 10vw">
        <v-tooltip location="bottom" min-width="100%" max-width="100%">

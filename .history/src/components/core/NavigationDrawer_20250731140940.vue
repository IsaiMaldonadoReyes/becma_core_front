      ...
      try {
        ...
        items.value = [
          ...
          },
          {
            ...
            ruta: '/comercial/ventasporconceptochart',
            icono: 'mdi-cart-percent',
            orden: 1,
          },
          {
            id: 11,
            ...
            nombre: 'LayoutDispersion',
            descripcion: 'Layout de bancos para dispersión',
            etiqueta: 'Ventas por cliente',
            ruta: '/comercial/ventasporclientechart',
            icono: 'mdi-face-woman-shimmer',
            orden: 1,
          },
          {
            id: 12,
            ...
            nombre: 'LayoutDispersion',
            descripcion: 'Layout de bancos para dispersión',
            etiqueta: 'Ventas por agente',
            ruta: '/comercial/ventasporagentechart',
          ...
          },
          {
            ...
            ruta: '/comercial/ventaspresupuestochart',

<template>
  <v-app>
    <v-app-bar app clipped-left height="60" color="#E6E9F5">
      ...
      <v-btn-group variant="outlined" divided class="ml-md-1 ml-lg-1 ml-xl-1">
        <v-btn @click.stop="onClickDrawer" :icon="icon"></v-btn>
        <v-btn icon="mdi-format-list-bulleted"></v-btn>
      </v-btn-group>
      <v-toolbar-title>
    ...
    <!-- Drawer hijo -->
    <v-navigation-drawer permanent v-model="drawerChildren" elevation="10" nav border>
      <v-list>

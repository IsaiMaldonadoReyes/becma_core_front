<template>
  <v-app>
    <v-app-bar app clipped-left height="60" color="#E6E9F5">
      ...
      <v-btn-group variant="outlined" divided class="ml-md-3 ml-lg-1 ml-xl-1">
    ...
    <!-- Drawer padre -->
    <v-navigation-drawer permanent :rail="railParent" v-model="drawerParent" rail-width="130">
    ...
    <!-- Drawer hijo -->
    <v-navigation-drawer permanent v-model="drawerChildren" elevation="10" nav :rail="railChildren">
      <v-list>
...
export default defineComponent({
  ...
  setup() {
    ...
    const icon = ref('mdi-menu-open')
    const iconChildren = ref('mdi-menu-close')

<template>
  <v-dialog v-model="dialogPropiedades.dialog" width="auto" persistent>
    <div class="bg-surface position-relative rounded">
      <div class="bg-surface position-relative ps-3 rounded" style="padding: 125px 0px 100px 0px">
        <!-- position-absolute used for demonstration purposes -->
        <div class="position-absolute top-0 left-0 right-0 rounded-t bg-surface-light pa-3 w-100">
        ...
        <div class="overflow-y-auto pe-3" style="height: calc(100% - 125px); padding-top: 8px">
          <div class="mt-2">Relative parent</div>

          <v-form ref="form" v-model="isValid" class="pa-3 mt-5">
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field

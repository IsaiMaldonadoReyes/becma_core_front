<template>
  <v-dialog v-model="dialogPropiedades.dialog" width="auto" persistent>
    <div class="bg-surface pa-4 position-relative rounded-lg ma-2">
    ...
    <div class="position-relative">
      <div class="bg-surface-light position-relative py-3 ps-3">
        ...
        <div class="overflow-y-auto pe-3" style="max-height: 200px">
          <v-card class="mt-16">
            <v-form ref="form" v-model="isValid">
              <v-card-title class="bc-toolbar"> </v-card-title>
              <v-divider class="border-opacity-25" />
              <v-card-text class="pa-md-8 overflow-y-auto">
                <v-row>
                  <v-col cols="12" md="6">
                    <v-text-field

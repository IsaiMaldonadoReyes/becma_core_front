<template>
  <v-dialog v-model="dialogPropiedades.dialog" width="auto" persistent>
    <div class="position-relative rounded-lg">
      <div class="bg-surface position-relative py-3 ps-3">
        <!-- position-absolute used for demonstration purposes -->
        <div class="position-absolute top-0 left-0 right-0 bg-primary pa-3 w-100">Fixed child</div>

        <div class="overflow-y-auto pe-3" style="max-height: 300px">
          <v-form ref="form" v-model="isValid">
            <v-row class="pa-3 mt-12">
              <v-col cols="12" md="6">
                <v-text-field
    ...
    <div class="pa-4 position-relative rounded-lg ma-10">
      <div class="bg-surface position-relative py-3 ps-3">
        <!-- position-absolute used for demonstration purposes -->
        <div class="position-absolute top-0 left-0 right-0 bg-surface-light pa-3 w-100">
          hola
          <!--v-row>
        ...
        <div class="overflow-y-auto pe-3" style="max-height: 250px">
          ...
          <div v-for="n in 10" :key="n" class="bg-info rounded-lg pa-3 mt-2">Static child</div>

<template>
  <v-dialog v-model="dialogPropiedades.dialog" width="auto" persistent>
    <div class="bg-surface position-relative rounded-lg">
      <div class="bg-surface position-relative py-16 ps-3 rounded-lg">
        <!-- position-absolute used for demonstration purposes -->
        <div class="position-absolute top-0 left-0 right-0 rounded-lg bg-surface-light pa-3 w-100">
          <v-row>

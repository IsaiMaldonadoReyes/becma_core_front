<template>
  <v-dialog v-model="dialogPropiedades.dialog" max-width="80%" persistent rounded="xl">
    <v-card>
      <v-toolbar>
        <v-toolbar-title>
      ...
      <v-card-actions class="text-center">
        <v-btn color="grey" size="large" variant="elevated" @click="cerrarDialogPropiedades">
          Cancelar
        </v-btn>
        <v-btn color="primary" size="large" variant="elevated" @click="cerrarDialogPropiedades">
          Guardar
        </v-btn>
      </v-card-actions>
    </v-card>

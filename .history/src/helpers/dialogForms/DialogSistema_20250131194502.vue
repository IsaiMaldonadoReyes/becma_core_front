<template>
  <v-dialog v-model="dialogPropiedades.dialog" width="auto" persistent>
    <div class="bg-surface-light position-relative">
      <div class="bg-surface position-relative py-15 ps-3">
        ...
        <div class="overflow-y-auto pe-3" style="max-height: 250px">
          <div class="mt-15">Relative parent</div>

          <div v-for="n in 10" :key="n" class="bg-info rounded-lg pa-3 mt-2">
            Static child

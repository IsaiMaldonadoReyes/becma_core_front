<template>
  <v-dialog v-model="dialogPropiedades.dialog" width="auto" persistent>
    <v-card>
      <v-card-title class="position-fixed bg-white header"> Encabezado Fijo </v-card-title>
...
<script lang="ts">
import { ref, mergeProps, watch, defineComponent, computed } from 'vue'
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const contentStyle = computed(() => {
      if (header.value) {
        const headerHeight = header.value.offsetHeight // Altura del encabezado

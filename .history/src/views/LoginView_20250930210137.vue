      ...
      <v-col v-if="smAndDown" cols="12" md="2" ref="vtimContenidoRef">
        ...
        >
          <v-timeline-item
            ...
            class="cursor-pointer d-flex align-center justify-enter"
            fill-dot
            size="60px"
            @click="goTo(i)"
          >
            ...
            <v-card
              class="d-flex align-center justify-enter text-center rounded-lg"
              min-height="60px"
              color="#722B81"
              elevation="16"
              :min-width="getTimelineItemWidth"
              :max-width="getTimelineItemWidth"
              :style="{
                fontSize: '14px',
              }"
            >
              <div class="d-flex align-center justify-enter text-center">
                {{ step.title }}
              </div>
            </v-card>
          </v-timeline-item>

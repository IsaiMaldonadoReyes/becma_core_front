                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      />
                                      Capture el RFC del contribuyente tal como aparece en su constancia fiscal para emitir la factura correctamente.
                                    </v-card-text>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese un correo electrónico al que desee recibir el PDF y
                                      XML de la facura
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese alguna observación, opcional
                                    </v-card-text>
                                  </v-card>
                                </template>
                              </bec-text-field>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el Código postal de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      />
                                      Ingrese el Estado de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el nombre de la Ciudad de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el Municipio de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el nombre de la Colonia de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el nombre de la Calle de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el Número exterior de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                            ...
                            <v-col cols="6" class="pa-3">
                              ...
                              >
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-home-floor-1" />
...
export default defineComponent({
  ...
  setup() {
    ...
    const getRowFormularioDatosFiscalesHeight = computed(() => {
      if (vcarContenidoRef.value) {
        let alto = 0
        alto =
          vconPrincipalRef.value.$el.clientHeight * 0.8 -
          vrowTitulo2Ref.value.$el.clientHeight -
          vrowTabDatosFiscales.value.$el.clientHeight -
          vactFoot2Ref.value.$el.clientHeight -
          170
    ...
    return {
      ...
      getRowFormularioDatosFiscalesHeight,

  ...
  <v-container ref="vconPrincipalRef" class="fill-height login-body" fluid>
    ...
    <v-row>
      <v-img
        ...
        "
      />
      <v-col cols="12" md="9" class="d-flex align-center justify-center" ref="vcarContenidoRef">
        <vue3-lottie
          width="400px"
          height="400px"
        ...
        <v-row :justify="smAndDown ? 'center' : 'end'">
          <v-col cols="12" md="9">
            <v-card
              color="#E6E6E6"
              elevation="16"
      ...
      <v-col cols="12" md="2" ref="vtimContenidoRef">
        <v-timeline
          ...
          :style="{
            zIndex: 1,
            transform: smAndDown ? 'translateX(-50px)' : 'none',

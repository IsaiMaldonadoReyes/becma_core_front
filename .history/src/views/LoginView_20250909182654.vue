<template>
  <v-container class="d-flex align-center justify-center fill-height login-body" fluid>
    ...
    <v-card color="#E6E6E6" elevation="24" width="55%">
      <v-row>
        <v-col cols="12" lg="6">
          <v-card color="#E6E6E6" elevation="0" class="rainbow">
            <vue3-lottie
              width="100%"
              :animation-link="'/src/assets/images/login_barron_animation2.json'"
              style="background-color: #e6e6e6"
            />
          </v-card>
        </v-col>
        <v-col cols="12" lg="6" class="d-flex align-stretch justify-stretch">
          <v-card color="#E6E6E6" elevation="0" width="100%">
            <v-row class="d-flex align-center justify-center mt-3" style="height: 30%">
              <v-img
            ...
            <v-row class="d-flex align-center justify-center" style="height: 35%">

<template>
  <v-container fluid ref="vconPrincipalRef" class="h-100">
    ...
    <v-row ref="vtabTipoEmpresaRef">
      <v-col class="my-0 py-0">
        <v-tabs v-model="vtabTipoEmpresa" class="text-medium-emphasis" color="primary" grow height="40px">
          <v-tab
            ...
            <div class="d-lg-flex flex-lg-row" style="height: 100%">
              ...
              >
                <v-tab
                  ...
                  :key="tab.value"
                  :value="tab.value"
                  :variant="vtabGraficaSelected == 'option-1' ? 'tonal' : 'text'"
                  class="text-none text-no-wrap"
                  min-width="100%"
              ...
              <div class="flex-lg-grow-1 overflow-auto ml-2" :style="getCardHeight"></div>
            </div>
          </v-tabs-window-item>
          <!-- Empresa no fiscal -->

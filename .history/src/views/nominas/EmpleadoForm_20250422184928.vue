        ...
        <v-card elevation="5" class="pa-5 overflow-auto" :style="getCardHeight">
          <v-tabs-window v-model="vtabGraficaSelected">
            ...
            <v-tabs-window-item value="tab02" eager>
              <v-row><v-col>Datos generales</v-col></v-row>
              <v-row>
                <v-col cols="12" md="4">
                  <v-autocomplete
                    v-model="modelEmpresa"
                  ...
                  >
                    ...
                    <template v-slot:prepend>
                      <v-tooltip interactive>
                        ...
                        <span
                          >Identificador del <b>Departamento</b> al que pertenece el empleado.</span
                        >
                      </v-tooltip>
                    </template>
                  </v-autocomplete>
                  ...
                  >
                    ...
                    <template v-slot:prepend>
                      <v-tooltip interactive>
                        ...
                        <span>Identificador del <b>Puesto</b> al que pertenece el empleado.</span>
                      </v-tooltip>
                    </template>
                  </v-autocomplete>
                </v-col>
                  ...
                  >
                    ...
                    <template v-slot:prepend>
                      <v-tooltip interactive>
                        ...
                        <span>
                          Identificador del <b>Tipo de prestación</b> que fue asignado al empleado.
                        </span>
                      </v-tooltip>
                    </template>
                  </v-autocomplete>
                    ...
                    <template v-slot:prepend>
                      <v-tooltip interactive>
                        ...
                        <span>
                          ...
                          <br /><b>S =</b> Sueldo <br /><b>C =</b> Comisión <br /><b>D =</b> Destajo
                          <br /><b>O =</b> Sueldo/Comisión <br /><b>E =</b> Sueldo/Destajo
                        </span>
                      </v-tooltip>
                    </template>
                  </v-autocomplete>
                    ...
                    <template v-slot:prepend>
                      <v-tooltip>
                        ...
                        <span>
                          ...
                          <br /><b>A = </b> Zona A <br /><b>B = </b> Zona B <br /><b>C = </b> Zona C
                        </span>
                      </v-tooltip>
                    </template>
                  </v-autocomplete>
                  ...
                  >
                    <template v-slot:prepend>
                      <v-tooltip interactive>
                        ...
                        <span>Número de la cuenta de AFORE del empleado</span>
                      </v-tooltip>
                    </template>
                  </v-text-field>
                </v-col>
            ...
            <v-tabs-window-item value="tab03" eager>
              Datos afiliatorios IMMS, Infonavit
            </v-tabs-window-item>

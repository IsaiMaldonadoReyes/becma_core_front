<template>
  <v-container fluid ref="vconPrincipalRef" class="h-100">
    ...
    <v-row>
      ...
      <v-tooltip location="bottom" max-width="300px" color="primary">
        ...
        <template #default>
          <v-card color="transparent" elevation="0" class="pa-3">
            <v-row>
              <v-col cols="1" class="d-flex align-center justify-center">
                <v-icon icon="mdi-calendar" color="white" class="mr-1" />
              </v-col>
              <v-col cols="11">
                Ingrese la <b>fecha de alta</b> del empleado.  
                Este dato indica el día en que el trabajador comenzó su relación laboral.
              </v-col>
            </v-row>
            <v-divider class="border-opacity-50 my-2 mx-2" />
            <v-row>
              <v-col cols="1" class="d-flex align-center justify-center">
                <v-icon icon="mdi-alert" color="white" class="mr-1" />
              </v-col>
              <v-col cols="11">
                <b>Nota:</b> este campo es obligatorio para el cálculo de antigüedad y prestaciones.
              </v-col>
            </v-row>
          </v-card>
        </template>

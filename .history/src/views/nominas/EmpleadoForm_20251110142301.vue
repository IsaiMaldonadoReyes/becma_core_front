            ...
            >
              <v-row>
                ...
                <v-col cols="11">
                  ...
                  Seleccione el <b style="color: #2a73c5"><i>CLIENTE</i></b> para el que
                  desea registrar nuevos empleados.
                </v-col>
              </v-row>
          ...
          <template #tooltip>
            ...
            >
              <v-row>
                ...
                <v-col cols="11">
                  <span style="font-weight: bold; color: #2a73c5">Instrucción:</span>
                  elija el tipo de empresa (fiscal o no fiscal) para mostrar únicamente
              ...
              <v-row>
                ...
                <v-col cols="11">
                  <span style="font-weight: bold; color: #2a73c5">Evento:</span>
                  al seleccionar una opción en este campo, se habilitará y mostrará la
              ...
              <v-row>
                ...
                <v-col cols="11">
                  <span style="font-weight: bold; color: #2a73c5"
                    >Campo dependiente:</span
                  >
                  debe seleccionar primero
                  <b style="color: #2a73c5"><i>TIPO DE EMPRESA</i></b> para poder
                      ...
                      <v-row class="mt-1 mx-2">
                        ...
                        <v-col cols="12" lg="5">
                          <bec-text-field
                            ...
                            @keypress="inputFilters.onlyAlphanumeric"
                            :disable="dataModel.ExtranjeroSinCURP ? true : false"
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaNombres" />
                            </template>

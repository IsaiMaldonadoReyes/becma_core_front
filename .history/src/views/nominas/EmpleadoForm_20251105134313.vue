              ...
              <div class="flex-lg-grow-1 overflow-auto ml-2" :style="getCardHeight">
                <v-form ref="formRefFiscal">
                  <v-tabs-window v-model="vtabGraficaSelected" :mobile="smAndDown">
                    ...
                    <v-tabs-window-item value="tab01" eager>
                      ...
                      <v-row class="mt-1 mx-2">
                            ...
                            <template #tooltip>
                              ...
                              >
                                <v-row>
                                  ...
                                  <v-col cols="11">
                                    Permite identificar el tipo de contrato con base al nuevo
                                    catálogo del SAT.
                                  </v-col>
                                </v-row>
                                <v-divider class="border-opacity-50 my-2" />
                        ...
                        <v-col cols="12" lg="4">
                          ...
                          >
                            <template #tooltip>
                              <EmpleadoTooltips name="baseCotizacion" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                              ...
                              >
                                ...
                                <v-row>
                                  ...
                                  <v-col cols="11">
                                    ...
                                    <b style="color: #2a73c5"><i>BASE DE COTIZACIÓN</i></b> para
                                    poder habilitar este campo.
                                  </v-col>
                                </v-row>
                                <v-divider class="border-opacity-50 my-2" />
                                <v-row>
                        ...
                        <v-col cols="12" lg="4">
                          <bec-text-field
                            ...
                            :placeholder="''"
                            :prepend-icon="'mdi-currency-usd'"
                            :tooltip="'Sueldo base de cotización variable'"
                            disabled
                          />
                        </v-col>
                    ...
                    <!-- Pagos y extras -->
                    <v-tabs-window-item value="tab06" eager>Datos Cálculos</v-tabs-window-item>
                  </v-tabs-window>
                </v-form>
              </div>
            </div>
...
import EmpleadoTooltips from 'src/components/nomina/ayudas/EmpleadoTooltips.vue'

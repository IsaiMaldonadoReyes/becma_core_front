  ...
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    <v-row ref="vbrePrincipalRef" dense>
      ...
      <v-col cols="12" md="6" class="d-flex align-end justify-end overflow-auto">
        ...
        <v-menu v-model="vbtnMenuImportarModel" :close-on-content-click="false">
          <template v-slot:activator="{ props: vbtnMenuImportarModel }">
            <v-tooltip bottom color="primary" interactive>
              ...
              <span>
                <v-icon icon="mdi-microsoft-excel" /> Importar empleados desde Excel
              </span>
            </v-tooltip>
          </template>
    ...
    <v-row>
      <v-col>
        <v-card variant="elevated" elevation="5" :style="getCardHeight">
          <v-data-table
              ...
              <v-row class="py-5">
                ...
                <v-col cols="12" md="6" class="d-flex justify-end align-center">
                  <v-tooltip interactive>
                      ...
                      >
                        <v-btn density="compact">
                          <v-text-field
                            ...
                            width="50"
                            @update:model-value="
                              vdtbPrincipalItemsPorPagina = parseInt($event, 10)
                            "
                          />
                        </v-btn>
                        ...
                        <v-menu>
                          ...
                          <v-list
                            color="primary"
                            v-model:selected="vdtbPrincipalItemsPorPagina"
                          >
                            <v-list-item
                    ...
                    <span>
                      Escriba o seleccione la cantidad de registros que desea ver por
                      página en la tabla.
                    </span>
                  </v-tooltip>
                  <v-btn
...
export default defineComponent({
  ...
  setup() {
    ...
    const getCardHeight = computed(() => {
      ...
      console.log(`${cardHeight.value}px !important`);

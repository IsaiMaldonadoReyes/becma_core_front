          ...
          >
            ...
            <v-row>
              ...
              <v-col cols="11">
                ...
                <b style="color: #2a73c5"><i>TIPO DE EMPRESA</i></b> para poder habilitar este campo
                y mostrar las empresas correspondientes.
              </v-col>
            </v-row>
            <v-divider class="border-opacity-50 my-2 mx-2" />
            <v-row>
...
import { useEmpresasStore } from '@/stores/modules/Nomina/gape/Empresa'

<template>
  <v-container ref="vconPrincipalRef">
...
export default defineComponent({
  ...
  setup() {
    ...
    const getCardHeight = computed(() => {
      ...
      console.log(height: `${cardHeight.value}px !important`)
    ...
    const calcularDimensiones = () => {
      if (vconPrincipalRef.value) {
        cardHeight.value =
          vconPrincipalRef.value.$el.clientHeight - vbrePrincipalRef.value.$el.clientHeight - 80
      }
    }

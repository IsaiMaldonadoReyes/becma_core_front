<template>
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <v-row ref="vrowClienteRef">
      ...
      <v-col lag="6">
        v-text-field v-model="item.tope" variant="underlined" clearable
        clear-icon="mdi-close" density="compact" hide-details prefix="$"
        :placeholder="'0.00'" class="text-end" color="primary" />
        <bec-autocomplete
                  ...
                  <v-row>
                    <v-col cols="12" lg="6">
                      <v-card-title class="text-medium-emphasis"
                        >Conceptos alternativos de pago</v-card-title
                      >
                      <v-divider class="border-opacity-25 ma-0 pa-0" />
                      <v-data-table
                        hide-default-footer

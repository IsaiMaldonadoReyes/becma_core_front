<template>
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <v-row ref="vtabMenuRef">
      <v-col class="my-0 py-0 d-flex flex-row">
        <v-tabs
                    ...
                    >
                      ...
                      <template v-slot:prepend>
                        <v-tooltip interactive>
                          ...
                          <span>
                            Es el sueldo mensual y en cuota diaria bruto, con el cual esta
                            dado de alta el colaborador ante el IMSS.
                          </span>
                        </v-tooltip>
                      </template>
                    </v-select>
                    ...
                    >
                      ...
                      <template v-slot:prepend>
                        <v-tooltip interactive>
                          ...
                          <span>
                            Son las provisiones de las prestaciones de ley como aguinaldo
                            y prima vacacional que se tendrán que calcular e ir
                            provisionado de acuerdo con cada periodo de pago, cuando
                            aplique.
                          </span>
                        </v-tooltip>
                      </template>
                    ...
                    >
                      ...
                      <template v-slot:prepend>
                        <v-tooltip interactive>
                          ...
                          <span>
                            Es el % de retención que se tiene que se tiene que realizar a
                            en la nómina fiscal, sobre sueldo o percepción bruta a los

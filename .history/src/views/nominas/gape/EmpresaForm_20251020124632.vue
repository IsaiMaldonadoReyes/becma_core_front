          ...
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="pa-3">
              <v-row>
                ...
                <v-col cols="11">
                  Elija el tipo de empresa que desea registrar: <br />Fiscal: la información será
                  considerada para procesos fiscales. No fiscal: se usa para registros sin efectos
                  fiscales.
                </v-col>
              </v-row>
              <v-divider class="border-opacity-50 my-2 mx-4" />

<template>
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
          ...
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="pa-3">
              <v-row>
                ...
                <v-col cols="11">
                  Es necesario configurar la parametrización de prenómina para cada una de las
    ...
    <v-row class="overflow-auto" :style="getCardHeight">
      <v-col cols="12" lg="6">
        <v-card-title class="text-medium-emphasis"> Conceptos alternativos de pago </v-card-title>
        <v-divider class="border-opacity-25 ma-0 pa-0" />
        <v-data-table
          hide-default-footer

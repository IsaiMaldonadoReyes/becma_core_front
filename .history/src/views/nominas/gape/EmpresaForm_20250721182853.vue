        ...
        <v-tabs-window v-model="vtabMenuModel">
          <v-tabs-window-item value="tab01" eager>
            <div class="d-lg-flex flex-lg-row" style="height: 100%">
              <v-tabs
                v-model="tabEmpresa"
                class="text-medium-emphasis tab-right"
                color="primary"
              ...
              <v-divider  class="border-opacity-25 ma-0 pa-0" vertical></v-divider>
              <div class="flex-lg-grow-1 overflow-auto" :style="getCardHeight">
                <v-tabs-window class="mx-2" v-model="tabEmpresa" :mobile="smAndDown">
    ...
    const calcularDimensiones = () => {
      if (vconPrincipalRef.value) {
        cardHeight.value =
          ...
          vtabMenuRef.value.$el.clientHeight - 15
      }
    }

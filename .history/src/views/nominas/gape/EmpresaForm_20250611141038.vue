...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = [
      ...
      { text: "Correo", key: "correo" },
      { text: "", key: "drag", sortable: false, align: "end" },
    ];

    const items = ref([
      { id: 1, nombre: "1Juan", correo: "juan@mail.com" },
      { id: 2, nombre: "2Ana", correo: "ana@mail.com" },
      { id: 3, nombre: "3Luis", correo: "luis@mail.com" },
    ]);

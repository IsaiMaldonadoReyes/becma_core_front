  ...
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <v-row ref="vbrePrincipalRef" dense>
      ...
      <v-col cols="12" md="6" class="d-flex align-center justify-end overflow-auto">
        ...
        <v-tooltip ref="vbtnCargar" bottom color="primary" interactive>
        ...
        <v-tooltip ref="vbtnDescargar" bottom color="primary" interactive>
          <template v-slot:activator="{ props: tooltipProps }">
            <v-btn
              v-bind="mergeProps(tooltipProps)"
              class="mr-1"
              ...
              width="48px"
            >
              <v-icon size="24px" color="white" icon="mdi-download"></v-icon>
            </v-btn>
          </template>
          <span>
            <v-icon icon="mdi-microsoft-excel" />

                        ...
                        <v-row class="pa-2">
                          <v-col cols="9">
                            <v-row>
                              ...
                              >
                                <v-icon color="#078929" icon="mdi-alert" size="18" start></v-icon>
                              </v-col>
                              <v-col cols="3" class="d-flex align-center justify-end"> </v-col>
                              <v-col
                                cols="3"
                                style="color: #722b81; font-size: 14px; font-weight: bold"
                              >
                              ...
                              <v-col cols="6" class="d-flex align-center justify-end"> </v-col>
                              <v-col
                                cols="6"
                                style="color: #722b81; font-size: 14px; font-weight: bold"
                              >

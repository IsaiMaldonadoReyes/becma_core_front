      ...
      <v-col cols="12" lg="6">
        ...
        <v-row class="mt-3">
          <v-col cols="12">
            ...
            >
              <template #tooltip>
                <v-card color="transparent" elevation="0" class="py-3" width="100%" >
                  <v-row>
                    <v-col cols="1" class="d-flex align-center justify-center">
                      <v-icon
                        class="mr-1"
          ...
          <v-col cols="12">
            ...
            >
              <template #tooltip>
                <v-card color="transparent" elevation="0" class="py-3" width="50vh">
                  <v-row>
                    <v-col cols="1" class="d-flex align-center justify-center">
                      <v-icon
                        class="mr-1"
          ...
          <v-col cols="12">
            ...
            >
              <template #tooltip>
                <v-card color="transparent" elevation="0" class="pa-3" width="50vw" >
                  <v-row>
                    <v-col cols="1" class="d-flex align-center justify-center">
                      <v-icon
                        class="mr-1"

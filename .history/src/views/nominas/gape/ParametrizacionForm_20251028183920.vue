          ...
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="pa-3">
              <v-row>
                ...
                <v-col cols="11">
                  <span style="font-weight: bold; color: #2a73c5">Instrucción:</span>
                  La parametrización debe configurarse de forma independiente para cada uno de los tipos de periodo manejados dentro de la empresa.

Elija el tipo de periodo (periodicidad) para el cual desea definir la configuración de prenómina.
                </v-col>
              </v-row>
              <v-divider class="border-opacity-50 my-2 mx-2" />
              <v-row>

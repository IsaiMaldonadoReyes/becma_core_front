                ...
                <v-card-text>
                  <v-row>
                    <v-col cols="12" lg="12">
                      ...
                      <v-card-text>
                        <draggable v-model="items" item-key="id" handle=".drag-handle">
                          <template #item="{ element }">
                            <v-list-item>
                              <v-list-item-icon>
                                <v-icon class="drag-handle" icon="mdi-drag" />
                              </v-list-item-icon>
                              <v-list-item-content>
                                <v-list-item-title>
                                  <v-text-field
...
export default defineComponent({
  ...
  setup() {
    ...
    const items = ref([
      { id: 1, nombre: "1Juan", correo: "juan@mail.com", drag: "" },
      { id: 2, nombre: "2Ana", correo: "ana@mail.com", drag: "" },
      { id: 3, nombre: "3Luis", correo: "luis@mail.com", drag: "" },
    ]);

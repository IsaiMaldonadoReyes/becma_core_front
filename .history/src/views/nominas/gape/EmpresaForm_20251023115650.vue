                                                  ...
                                                  >
                                                    <v-row>
                                                      ...
                                                      >
                                                        ...
                                                        Interbancario en la empresa. <br />Si el
                                                        banco se encuentra activo, podrá utilizarlo
                                                        en el layout de dispersión de nómina.
                                                      </v-col>
                                                      <v-col v-else cols="11">
                                                        Haga clic aquí para DESACTIVAR el Banco Azteca
                                                        Interbancario en la empresa. <br />Si el
                                                        banco se encuentra activo, podrá utilizarlo
                                                        en el layout de dispersión de nómina.
                                                      </v-col>

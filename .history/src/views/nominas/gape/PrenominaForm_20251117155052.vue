                                            ...
                                            <v-card color="transparent" elevation="0" class="py-3">
                                              <v-row>
                                                ...
                                                <v-col cols="11" v-else>
                                                  Haga clic aquí para
                                                  <b>DESHABILITAR</b> el Banco Fodeadora.<br />
                                                </v-col>
                                              </v-row>
                                          ...
                                          <template #default>
                                            <v-card color="transparent" elevation="0" class="py-3">
                                              <v-row>
                                                ...
                                                <v-col cols="11" v-else>
                                                  Haga clic aquí para
                                                  <b>DESHABILITAR</b> el Banco Azteca
                                                  Interbancario.<br />
                                                </v-col>
                                              </v-row>
                                          ...
                                          <template #default>
                                            <v-card color="transparent" elevation="0" class="py-3">
                                              <v-row>
                                                ...
                                                <v-col cols="11" v-else>
                                                  Haga clic aquí para
                                                  <b>DESHABILITAR</b> el Banco Azteca Bancario.<br />
                                                </v-col>
                                              </v-row>
                                          ...
                                          <template #default>
                                            <v-card color="transparent" elevation="0" class="py-3">
                                              <v-row>
                                                ...
                                                <v-col cols="11" v-else>
                                                  Haga clic aquí para
                                                  <b>DESHABILITAR</b> el Banco Banorte terceros.<br />
                                                </v-col>
                                              </v-row>

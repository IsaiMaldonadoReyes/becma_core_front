            ...
            <v-tabs-window-item value="tab01" eager>
              <v-card color="transparent">
                <v-card-title class="text-medium-emphasis text-body-1">
                  <v-row>
                    <v-col cols="6" class="d-flex align-center"> Parametrización </v-col>
                  </v-row>
                </v-card-title>
                <v-divider class="border-opacity-25"></v-divider>
                <v-card-text>
                  <v-row>
                    <v-col v-for="(campo, index) in camposTab1" :key="index" cols="12" lg="12">
                      <v-select
                        ...
                        :prepend-inner-icon="campo.icono"
                        chips
                        clear-icon="mdi-close"
                        clearable
                        color="primary"
                      ...
                      >
                        ...
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            <template v-slot:activator="{ props: tooltip }">
                              <v-icon :icon="campo.icono" v-bind="mergeProps(tooltip)" size="20" />
                            </template>
                            <span v-html="campo.ayuda" />
                          </v-tooltip>
                        </template>
                      </v-select>
                    </v-col>
                      ...
                      >
                        ...
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            ...
                            <span>
                              Es el sueldo mensual y en cuota diaria bruto, con el cual esta dado de
                              alta el colaborador ante el IMSS.
                            </span>
                          </v-tooltip>
                        </template>
                      </v-select>
                        ...
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            ...
                            <span>
                              ...
                              >, en caso de que indique que es <b><i>MEDIA</i></b> no es necesario
                              alimentar.
                            </span>
                          </v-tooltip>
                        </template>
                      ...
                      >
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            ...
                            <span> Es el porcentaje de comisión que se le cobrara al cliente </span>
                          </v-tooltip>
                        </template>
                      </v-text-field>
                    </v-col>
                      ...
                      >
                        ...
                        <template v-slot:prepend>
                          <v-tooltip>
                            ...
                            <span> Es la base sobre la cual se comisionará al cliente. </span>
                          </v-tooltip>
                        </template>
                      </v-select>
                    </v-col>
                      ...
                      >
                        ...
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            ...
                            <span>
                              Son las provisiones de las prestaciones de ley como aguinaldo y prima
                              vacacional que se tendrán que calcular e ir provisionado de acuerdo
                              con cada periodo de pago, cuando aplique.
                            </span>
                          </v-tooltip>
                        </template>
                      </v-select>
                      ...
                      >
                        ...
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            ...
                            <span>
                              Es el % de retención que se tiene que se tiene que realizar a en la
                              nómina fiscal, sobre sueldo o percepción bruta a los trabajadores
                              agremiados.
                            </span>
                          </v-tooltip>
                        </template>
                      ...
                      >
                        ...
                        <template v-slot:prepend>
                          <v-tooltip interactive>
                            ...
                            <span>
                              Primero selecciona el campo <b><i>Cliente</i></b> para habilitar esta
                              opción.
                            </span>
                          </v-tooltip>
                        </template>

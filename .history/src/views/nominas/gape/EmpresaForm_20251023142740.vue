                                                    ...
                                                    >
                                                      <v-row>
                                                        ...
                                                        <v-col cols="11" v-if="!isActiveFondeadora">
                                                          Haga clic aquí para <b>HABILITAR</b> el
                                                          Banco Fondeadora.
                                                        </v-col>
                                                        <v-col cols="11" v-else>
                                                          Haga clic aquí para <b>DESHABILITAR</b> el
                                                          Banco Fodeadora.<br />
                                                        </v-col>
                                                      </v-row>

                                                      <v-divider
                                                        class="border-opacity-50 my-2 mx-4"
                                                      />
                                                      ...
                                                      <v-row>
                                                        ...
                                                        <v-col cols="11" v-if="isActiveFondeadora">
                                                          ...
                                                          <b>HABILITADO</b>, podrá generar el layout
                                                          de dispersión de nómina correspondiente
                                                          para esta empresa.
                                                        </v-col>
                                                        <v-col cols="11" v-else>
                                                          <span style="font-weight: bold">
                                                          ...
                                                          si el banco se encuentra
                                                          <b>DESHABILITADO</b>, no podrá generar el
                                                          layout de dispersión de nómina
                                                          correspondiente para esta empresa.
                                                        </v-col>
                                                      </v-row>
                                                    </v-card>
                                                  </template>
...
import BancoBancarioModalForm from '@/views/nominas/gape/BancoAztecaBancarioModalForm.vue'
...
export default defineComponent({
  name: 'EmpresaForm',
  components: { BecSelect, BecAutocomplete, BecTextField, BancoAztecaInterbancarioModalForm, BancoBancarioModalForm, BancoBanorteTercerosModalForm },
  props: {
    id: {
      type: Number,
      required: false,

      ...
      <v-col cols="12" md="6" class="d-flex align-center justify-end overflow-auto">
        ...
        <v-tooltip bottom color="primary" interactive>
          <template v-slot:activator="{ props: tooltipProps }">
            <v-btn
              ...
              width="48px"
            >
              <v-icon size="24px" color="white" icon="mdi-upload" />
            </v-btn>
          </template>
          <span>
        ...
        <v-tooltip bottom color="primary" interactive>
          <template v-slot:activator="{ props: tooltipProps }">
            <v-btn
              ...
              width="48px"
            >
              <v-icon size="24px" color="white" icon="mdi-download" />
            </v-btn>
          </template>
          <span>
            <v-icon icon="mdi-microsoft-excel" />
        ...
        <v-tooltip bottom color="primary" interactive>
          <template v-slot:activator="{ props: tooltipProps }">
            <v-btn
              ...
              width="48px"
            >
              <v-icon size="24px" color="white" icon="mdi-delete" />
            </v-btn>
          </template>
          <span>Eliminar</span>
        </v-tooltip>
        ...
        <v-tooltip bottom color="primary" interactive>
          <template v-slot:activator="{ props: tooltipProps }">
            <v-btn
              ...
              width="48px"
            >
              <v-icon size="24px" color="white" icon="mdi-floppy" />
            </v-btn>
          </template>
          <span>Guardar</span>
        </v-tooltip>
        ...
        <v-tooltip bottom color="primary">
          <template v-slot:activator="{ props }">
            ...
            >
              <v-icon size="24px" color="white" icon="mdi-plus">mdi-plus</v-icon>
            </v-btn>
          </template>

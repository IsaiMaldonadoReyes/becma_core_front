                    ...
                    <v-tabs-window-item value="tab03" eager>
                      ...
                      <v-row class="mt-1 mx-2">
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaEntidadFederativaNacimiento" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                    ...
                    <v-tabs-window-item value="tab05" eager>
                      ...
                      <v-row class="mt-1 mx-2">
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaSucursalParaPagoElectronico" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaNumeroDeCuentaParaPagoElectronico" />
                            </template>
                          </bec-text-field>
                        </v-col>

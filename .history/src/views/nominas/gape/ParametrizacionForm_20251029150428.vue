  ...
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <v-row ref="vrowFiltrosRef">
      <v-col cols="12" lg="9">
        ...
        >
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="py-3" :max-width="$vuetify.display.smAndDown ? '90vw' : '400px'">
              <v-row>
            ...
            <v-card color="transparent" elevation="0" class="py-3">
              ...
              <v-row>
                ...
                <v-col cols="11">
                  ...
                  debe seleccionar primero <b style="color: #2a73c5"><i>TIPO DE EMPRESA</i></b> para
                  poder habilitar este campo y mostrar las empresas correspondientes.
                </v-col>
              </v-row>
              <v-divider class="border-opacity-50 my-2 mx-2" />
              <v-row>
          ...
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="pa-3">
              ...
              <v-row>
                ...
                <v-col cols="11">
                  <span style="font-weight: bold; color: #2a73c5">Campo dependiente:</span>
                  debe seleccionar primero <b style="color: #2a73c5"><i>EMPRESA</i></b> para poder
                  habilitar este campo y mostrar los tipos de periodo manejados en la empresa.
                </v-col>
              </v-row>
            </v-card>
          </template>
      ...
      <v-col cols="12" lg="6">
        ...
        <v-row class="mt-3">
          <v-col cols="12">
            ...
            >
              <template #tooltip>
                <v-card color="transparent" elevation="0" class="py-3" max-width="40vw" >
                  <v-row>
                    <v-col cols="1" class="d-flex align-center justify-center">
                      <v-icon
                        class="mr-1"
          ...
          <v-col cols="12">
            <bec-text-field
              v-model="modelSueldoIMSS"
              :clearable="true"
              :label="'Prima de riesgo actualizada'"
              :placeholder="'0.00'"
              :prefix="'%'"
              :prepend-icon="'mdi-account-key'"
              ...
              <template #tooltip>
                <v-card color="transparent" elevation="0" class="pa-3">
                  <v-row>
                    ...
                    <v-col cols="11">
                      <span style="font-weight: bold; color: #2a73c5">Instrucción:</span> indique la
                      base de cálculo que se utilizará para determinar la comisión aplicada al
                      cliente.
                    </v-col>
                  </v-row>
                </v-card>
          ...
          <v-col cols="12">
            ...
            >
              <template #tooltip>
                <v-card color="transparent" elevation="0" class="pa-3" max-width="40vw" >
                  <v-row>
                    <v-col cols="1" class="d-flex align-center justify-center">
                      <v-icon
                        class="mr-1"

<template>
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <banco-azteca-interbancario-modal-form
      ...
      :id-cliente="modalFormBancoAztecaInterbancario.idCliente"
      :id-empresa="modalFormBancoAztecaInterbancario.idEmpresa"
...
export default defineComponent({
  name: 'EmpresaForm',
  components: { BecSelect, BecAutocomplete, BecTextField, BancoAztecaInterbancarioModalForm },
  props: {
    id: {
      type: Number,
      required: false,

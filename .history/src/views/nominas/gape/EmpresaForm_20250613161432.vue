                          ...
                          <v-btn
                            :append-icon="
                              isExpanded(internalItem)
                                ...
                                : 'mdi-chevron-down'
                            "
                            :text="isExpanded(internalItem) ? 'Collapse' : 'Ver más'"
                            class="text-none"
...
export default defineComponent({
  ...
  setup() {
    ...
    const headers2 = [
      { title: "Clase de Prima de Riesgo", key: "title", align: "start", sortable: true },
      { title: "Valor", key: "director" },
      { title: "FEE", key: "genre" },
      { title: "BASE FEE", key: "year", align: "end" },
      { title: "Provisiones", key: "runtime", align: "end" },
    ];

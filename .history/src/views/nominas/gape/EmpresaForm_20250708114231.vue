...
export default defineComponent({
  ...
  setup() {
    ...
    const movies = [
      {
        ...
        cuentasDeOrigen: ['1000000000', '2020202020'],
      },
      {
    ...
    const agregarFila = (item: any) => {
      const fondeadora = movies.find((item) => item)
      if (fondeadora) {
        if (!Array.isArray(fondeadora.cuentasDeOrigen)) {
          fondeadora.cuentasDeOrigen = []
        }
        fondeadora.cuentasDeOrigen.push('')
      }
    }

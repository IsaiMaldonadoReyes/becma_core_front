            ...
            <div class="d-flex flex-row">
              ...
              >
                <v-tab
                  ...
                  variant="tonal"
                ></v-tab>
                <v-tab prepend-icon="mdi-lock" text="Bancos" value="option-2" class="text-none text-no-wrap" variant="outlined"
                  style="letter-spacing: 0.5px"></v-tab>
              </v-tabs>
              <v-divider class="mr-5 border-opacity-50" vertical />

                          ...
                          <template #tooltip>
                            <v-card color="transparent" elevation="0" class="pa-3">
                              <v-row>
                                ...
                                <v-col cols="11">
                                  Elija el cliente al que se asociará la nueva empresa.
                                </v-col>
                              </v-row>
                              <v-divider class="border-opacity-50 my-2 mx-2" />
                              <v-row>
                                ...
                                <v-col cols="11">
                                  <span style="font-weight: bold">Nota:</span>
                                  antes de crear una nueva empresa, seleccione el cliente
                                  correspondiente. Esto le permitirá continuar con el proceso de
                                  registro.
                                </v-col>
                              </v-row>
                            </v-card>

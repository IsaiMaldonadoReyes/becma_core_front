...
export default defineComponent({
  ...
  props: {
    idCliente: { type: Number as PropType<number | null>, default: null },
    idEmpresa: { type: Number as PropType<number | null>, default: null },
    dialogEvent: String,
    dialogTitle: String,
    dialogView: Boolean,
  },
  setup(props, { emit }) {
    ...
    const dialogPropiedades = ref({
      idCliente: ref(props.idCliente),
      idEmpresa: ref(props.idEmpresa),

<template>
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <v-row ref="vrowBarraDeAccionesRef" dense>
      <v-col cols="12" md="6" class="d-flex align-center ma-0 pa-0">
      ...
      <v-col cols="12" md="6" class="d-flex align-center justify-end overflow-auto ma-0 pa-0">
        ...
        <v-tabs-window v-model="vtabMenuModel">
          <v-tabs-window-item value="tab01" eager>
            <div class="d-lg-flex flex-lg-row" >
              <v-tabs
                v-model="tabEmpresa"
                class="text-medium-emphasis tab-right mr-1"
                color="primary"

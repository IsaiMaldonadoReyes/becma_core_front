                                                  ...
                                                  >
                                                    <v-row>
                                                      ...
                                                      <v-col
                                                        ...
                                                        cols="11"
                                                      >
                                                        Haga clic aquí para <b>ACTIVAR</b> el Banco
                                                        Azteca Interbancario. <br />Si el banco se
                                                        encuentra activo, podrá generar el layout de
                                                        dispersión de nómina correspondiente para
                                                        esta empresa.
                                                      </v-col>
                                                      <v-col v-else cols="11">
                                                        Haga clic aquí para DESACTIVAR el Banco
                                                        Azteca Interbancario en la empresa. <br />Si
                                                        el banco se encuentra activo, podrá
                                                        utilizarlo en el layout de dispersión de
                                                        nómina.
                                                      </v-col>
                                                    </v-row>
                                                    <v-divider
                                                    ...
                                                    <v-row>
                                                      ...
                                                      <v-col cols="11">
                                                        <span style="font-weight: bold">Nota:</span>
                                                        Si el banco se encuentra activo, podrá
                                                        generar el layout de dispersión de nómina

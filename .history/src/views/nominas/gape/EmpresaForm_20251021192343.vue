                        ...
                        <v-data-iterator :items="itemsBanco" items-per-page="-1">
                          <template v-slot:default="{ items }">
                            <v-row>
                                  ...
                                  <v-row class="pa-2">
                                    ...
                                    <v-col cols="3" class="d-flex align-center justify-end">
                                      ...
                                      <v-tooltip bottom color="primary" interactive>
                                        ...
                                        <span>Clic aquí para agregar propiedades</span>
                                      </v-tooltip>
                                    </v-col>
                                  </v-row>
                                </v-card>
                              ...
                              <v-col key="id" cols="12" md="12">
                                <v-expansion-panels elevation="0" class="ma-3 border">
                                  <v-expansion-panel>
                                            ...
                                            <template #tooltip>
                                              ...
                                              >
                                                <v-row>
                                                  ...
                                                  <v-col cols="11">
                                                    Ingrese el folio de su recibo tal como aparece
                                                    en el comprobante de pago. Este dato permite
                                                    identificar y validar correctamente la operación

        ...
        >
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="pa-3">
              ...
              <v-row>
                <v-col cols="1" class="d-flex align-center justify-center">
                  <v-icon class="mr-1" color="white" icon="mdi-file-rotate-left-outline" />
                </v-col>
                <v-col cols="11">
                  <span style="font-weight: bold">Campo relacionado:</span>
                  debe seleccionar <b style="color: #2a73c5">TIPO DE EMPRESA</b> para poder
                  habilitar el campo y mostrar las empresas correspondientes.
                </v-col>
              </v-row>
            </v-card>
          </template>

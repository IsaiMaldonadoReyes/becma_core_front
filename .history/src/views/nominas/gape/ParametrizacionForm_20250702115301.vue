    ...
    <v-row ref="vbrePrincipalRef" dense>
      <v-col cols="12" md="6" class="d-flex align-center">
        <v-tooltip interactive>
          ...
          <v-icon icon="mdi-clock-time-eight" size="12" />
          <span style="font-size: 10px">
            Fecha de creación: 02/04/2025 14:52:02<br />
            <v-icon icon="mdi-clock-time-eight" size="12" /> Última edición: 02/04/2025
            14:52:02<br />
            Última modificación: Administrador 2 | 02/04/2025 14:52:02
          </span>
        </v-tooltip>
        <v-breadcrumbs

      ...
      <v-col>
        ...
        <v-tabs-window v-model="vtabTipoEmpresa">
          ...
          <v-tabs-window-item value="tabTipoEmpresa01" eager>
            <div class="d-lg-flex flex-lg-row overflow-auto" :style="getCardHeight">
                ...
                <v-row class="mt-1 mx-2">
                  ...
                  <v-col cols="12" lg="4">
                    <bec-text-field
                      ...
                      :rules="[
                        (v: any) => validationRules.validatePositiveNumber(v, { required: false }),
                      ]"
                  ...
                  <v-col cols="12" lg="4">
                    <bec-text-field
                      ...
                      @keypress="(e: any) => inputFilters.onlyDecimal(e, dataModel.sueldointegrado)"
                    >
                      <template #tooltip>

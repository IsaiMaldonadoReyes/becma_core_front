          ...
          <v-tabs-window-item value="tab01" eager>
            <v-row>
              <v-col>
                ...
                <v-card-title color="primary" class="text-medium-emphasis text-body-1 mx-0 px-0">
            ...
            <v-row>
              <v-col>
                <v-divider class="border-opacity-25 ma-0 pa-0" />
                <v-card-title color="primary" class="text-medium-emphasis text-body-1 px-0"">
                  Bancos para layouts de dispersión
                </v-card-title>
                <v-divider class="border-opacity-25 ma-0 pa-0" />
              </v-col>
            </v-row>

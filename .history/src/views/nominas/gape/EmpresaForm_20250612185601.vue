                      ...
                      >
                        ...
                        >
                          <v-checkbox-btn
                            ...
                            color="primary"
                            @update:model-value="
                              (val) => onSelectChange(val, internalItem, toggleSelect)
                            "
                          />
                        </template>
                        <template v-slot:item.seleccionado="{ item }">
                          <v-chip
                            :color="itemsSeleccionados.includes(item) ? 'green' : 'red'"
                            size="small"
                            label
                          >
                            {{ itemsSeleccionados.includes(item) ? "Sí" : "No" }}
                          </v-chip>
                        </template>
...
export default defineComponent({
  ...
  setup() {
    ...
    const headers = [
      ...
      { title: "", key: "seleccionado", sortable: false },
    ...
    const onSelectChange = (
      ...
      toggleSelect(item); // actualiza la selección
      console.log("Seleccionado:", checked, item);

      // Aquí puedes hacer cualquier otra acción personalizada:
      // por ejemplo:
      // item.etiqueta = checked ? 'Sí' : 'No'
    };

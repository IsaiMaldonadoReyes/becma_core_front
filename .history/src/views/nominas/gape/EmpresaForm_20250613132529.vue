                      ...
                      <v-row>
                        ...
                        <v-col cols="12">
                          <bec-select
                            ...
                            :rules="[(v) => !!v || 'Este campo es requerido']"
                            :tooltip="'Son las provisiones de las prestaciones de ley como
...
export default defineComponent({
  ...
  setup() {
    ...
    const itemsBaseFEE = ref([
      ...
      { title: "Percepciones brutas más carca", value: 1 },
      { title: "Neto", value: 1 },
      { title: "Neto más carga social", value: 1 },
      { title: "FEE Neto + Bruto + CS", value: 1 },
    ]);

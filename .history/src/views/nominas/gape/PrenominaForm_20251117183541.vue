...
import { usePruebaExcelStore } from '@/stores/modules/Nomina/gape/PruebaExcel'
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const pruebaExcelStore = usePruebaExcelStore()
    ...
    const fetchExcel = async () => {
      const data = {
        ...
        periodoInicial: 1,
        periodoFinal: 2,
        departamentoInicial: 1,
        departamentoFinal: 2,
        empleadoInicial: 1,
        empleadoFinal: 2,
      }

      await pruebaExcelStore.fetchExcel(data)
    }
    return {
      btnDisabled,

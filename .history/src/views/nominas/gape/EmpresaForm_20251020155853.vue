                    ...
                    <v-row class="mt-1">
                      <v-col cols="12">
                        <bec-autocomplete
                          ...
                          :item-value="'id'"
                          :items="itemsEmpresas"
                          :label="'Empresa CONTAPQi de Nóminas'"
                          :multiple="false"
                          ...
                          <template #tooltip>
                            <v-card color="transparent" elevation="0" class="pa-3">
                              <v-row>
                                ...
                                <v-col cols="11">
                                  Elija la empresa del sistema CONTPAQi Nóminas que desea vincular a
                                  la nueva empresa Fiscal para establecer la conexión
                                  correspondiente.
                                </v-col>
                              </v-row>
                              <v-divider class="border-opacity-50 my-2 mx-2" />

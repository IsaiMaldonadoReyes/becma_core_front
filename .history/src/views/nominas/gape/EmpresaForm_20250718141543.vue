  ...
  <v-container ref="vconPrincipalRef" fluid style="height: 95% !important">
    ...
    <v-card>
      ...
      <div class="d-flex flex-row">
        <v-tabs v-model="tabEmpresa" color="primary" direction="vertical">
        ...
        <v-tabs-window v-model="tabEmpresa">
          ...
          <v-tabs-window-item value="option-2">
            <v-card flat>
              <v-card-text>
                ...
                <p>
                  Suspendisse feugiat. Suspendisse faucibus, nunc et pellentesque egestas, lacus
                  ante convallis tellus, vitae iaculis lacus elit id tortor. Proin viverra, ligula
                  sit amet ultrices semper, ligula arcu tristique sapien, a accumsan nisi mauris ac
                  eros. In hac habitasse platea dictumst. Fusce ac felis sit amet ligula pharetra
                  condimentum.
                </p>
                ...
                <p class="mb-0">
                  Donec venenatis vulputate lorem. Aenean viverra rhoncus pede. In dui magna,
                  posuere eget, vestibulum et, tempor auctor, justo. Fusce commodo aliquam arcu.
      ...
      <v-col>
        <v-tabs-window v-model="vtabMenuModel">
          <v-tabs-window-item value="tab01" eager>
            <div class="d-flex flex-row">
              <v-tabs v-model="tabEmpresa" color="primary" direction="vertical">
                <v-tab prepend-icon="mdi-account" text="General" value="option-1"></v-tab>
                <v-tab prepend-icon="mdi-lock" text="Bancos" value="option-2"></v-tab>
              </v-tabs>
              <v-tabs-window v-model="tabEmpresa">
                <v-tabs-window-item value="option-1">
                  <v-row>

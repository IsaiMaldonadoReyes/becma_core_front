  ...
  <v-container fluid ref="vconPrincipalRef" class="h-100">
    ...
    <v-row ref="vrowBarraDeAccionesRef" dense>
      ...
      <v-col cols="12" md="6" class="d-flex align-center justify-end overflow-auto">
        ...
        <v-tooltip bottom color="primary" interactive location="bottom">
          ...
          <template #default> Ejecutar cálculo de prenomina </template>
        </v-tooltip>
    ...
    <v-row ref="vrowFiltrosRef">
      <v-col cols="12">
        ...
        >
          <template #tooltip>
            <empleado-tooltips name="ayudaFiltroCliente" />
          </template>
        </bec-autocomplete>
      </v-col>
      <v-col cols="12" md="3">
                    ...
                    <v-tabs-window-item value="tab03" eager>
                      ...
                      <v-row class="mt-1 mx-2">
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaNumeroSeguridadSocial" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaRegistroPatronal" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaUMF" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaEstadoCivil" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaSexo" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips
                                name="ayudaEntidadFederativaNacimiento"
                              />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaCiudadNacimiento" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="4">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaHomoclave" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="5">
                          <bec-text-field
                            ...
                            :clearable="true"
                            :disabled="dataModel.ExtranjeroSinCURP"
                            :label="'CURP *'"
                            :placeholder="'CURP'"
                            :prepend-icon="'mdi-file-account-outline'"
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaCURP" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="3" class="d-flex align-start">
                          <div style="pointer-events: auto; cursor: help">
                            <v-tooltip location="bottom">
                              ...
                              <template #default>
                                <empleado-tooltips name="ayudaExtranjeroSinCurp" />
                              </template>
                            </v-tooltip>
                          </div>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaDireccion" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaPoblacion" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaEntidadFederativaDomicilio" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                        ...
                        <v-col cols="12" lg="3">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaTelefono" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaPadre" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaMadre" />
                            </template>
                          </bec-text-field>
                        </v-col>
                    ...
                    <v-tabs-window-item value="tab04" eager>
                      ...
                      <v-row class="mt-1 mx-2">
                        ...
                        <v-col cols="12" lg="4">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaSueldoVariable" />
                            </template>
                          </bec-text-field>
                        </v-col>

                        <!-- Fecha sueldo variable -->
                        <v-col cols="12" lg="4">
                          <v-locale-provider locale="es-MX">
                            <v-date-input
                            ...
                            >
                              <template v-slot:prepend>
                                <empleado-tooltips name="ayudaFechaSueldoVariable" />
                              </template>
                            </v-date-input>
                          </v-locale-provider>
                        </v-col>
                        ...
                        <v-col cols="12" lg="4">
                          <v-locale-provider locale="es-MX">
                            ...
                            >
                              <template v-slot:prepend>
                                <empleado-tooltips name="ayudaFechaSueldoDiario" />
                              </template>
                            </v-date-input>
                          </v-locale-provider>
                        </v-col>
                        ...
                        <v-col cols="12" lg="4">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaSueldoPromedio" />
                            </template>
                          </bec-text-field>
                        </v-col>

                        <!-- Fecha sueldo promedio -->
                        <v-col cols="12" lg="4">
                          <v-locale-provider locale="es-MX">
                            <v-date-input
                            ...
                            >
                              <template v-slot:prepend>
                                <empleado-tooltips name="ayudaFechaSueldoPromedio" />
                              </template>
                            </v-date-input>
                          </v-locale-provider>
                        </v-col>

                        <!-- Fecha sueldo integrado -->
                        <v-col cols="12" lg="4">
                          <v-locale-provider locale="es-MX">
                            <v-date-input
                            ...
                            >
                              <template v-slot:prepend>
                                <empleado-tooltips name="ayudaFechaSueldoIntegrado" />
                              </template>
                            </v-date-input>
                          </v-locale-provider>
                        </v-col>
                        ...
                        <!-- Sueldo base liquidación -->
                        <v-col cols="12" lg="4">
                          <bec-text-field
                            v-model="dataModel.sueldobaseliquidacion"
                            :label="'Sueldo base liquidación'"
                            :placeholder="'0.00'"
                            prefix="$"
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaSueldoBaseLiquidacion" />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="4">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaSueldoDelAjusteAlNeto" />
                            </template>
                          </bec-text-field>
                        </v-col>
                      </v-row>
                      ...
                      <v-row class="mt-1 mx-2">
                        ...
                        <v-col cols="12" lg="6">
                          <bec-autocomplete
                            ...
                            :label="'Banco para pago electrónico *'"
                            :multiple="false"
                            :placeholder="'Seleccione'"
                            :prepend-icon="'mdi-bank-circle'"
                            :return-object="false"
                          >
                            <template #tooltip>
                              <empleado-tooltips name="ayudaBancoParaPagoElectronico" />
                            </template>
                          </bec-autocomplete>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips
                                name="ayudaSucursalParaPagoElectronico"
                              />
                            </template>
                          </bec-text-field>
                        </v-col>
                        ...
                        <v-col cols="12" lg="6">
                          ...
                          >
                            <template #tooltip>
                              <empleado-tooltips
                                name="ayudaNumeroDeCuentaParaPagoElectronico"
                              />
                            </template>
                          </bec-text-field>
                        </v-col>

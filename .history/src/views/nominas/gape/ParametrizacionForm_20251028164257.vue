            ...
            <v-card color="transparent" elevation="0" class="pa-3">
              ...
              <v-row>
                ...
                <v-col cols="11">
                  ...
                  esté es un <i>Campo dependiente</i> debe seleccionar primero el
                  <b style="color: #2a73c5">TIPO DE EMPRESA</b> para poder habilitar el campo y
                  mostrar las empresas correcpondientes.
                </v-col>
              </v-row>
            </v-card>
          </template>

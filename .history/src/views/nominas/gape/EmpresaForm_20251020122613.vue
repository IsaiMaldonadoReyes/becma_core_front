          ...
          <template #tooltip>
            <v-card color="transparent" elevation="0" class="pa-3">
              <v-row>
                ...
                <v-col cols="11">
                  Ingrese el folio de su recibo tal como aparece en el comprobante de pago. Este
                  dato permite identificar y validar correctamente la operación antes de generar la
                  factura.
                </v-col>
              </v-row>

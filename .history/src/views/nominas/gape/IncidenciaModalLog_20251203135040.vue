            ...
            <v-col>
              <v-data-iterator :items="itemsLog" items-per-page="-1">
                <template v-slot:default="{ items }">
                  <v-row>
                    <v-col cols="12" md="12">
                      <v-card class="rounded pa-3" color="#f0f0f0" elevation="0" min-height="60px">
                        <v-row>
                          <v-col cols="1"> </v-col>
                          <v-col cols="11">
                        ...
                        <v-row>
                          ...
                          <v-col cols="5">
                            ...
                            <br />
                            <span>
                              Las siguientes celdas tienen valores que no son de tipo númerico.
                            </span>
                          </v-col>
                          <v-col cols="5">
                            <span style="font-weight: bold; color: #af1023; font-size: 18px">
  ...
  setup(props, { emit }) {
    ...
    const itemsErrores = [
      ...
      },
      {
        ...
        tipo: 'vacaciones',
        celdas: 'B1,B2,B3',
        mensaje: 'esta superando la cantidad de días disponibles',
      },
      {
        agrupador: 'nomina',
        tipo: 'incidencias',
        celdas: 'B1,B2,B3',
        mensaje: 'Esta superando la cantidad de incidencias de los dias del periodo',
      },
    ]

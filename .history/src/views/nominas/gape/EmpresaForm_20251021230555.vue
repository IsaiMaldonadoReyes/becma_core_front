                                          ...
                                          <v-expansion-panel-text>
                                            ...
                                            >
                                              ...
                                              <template v-slot:item.claveDeBancoId="{ item }">
                                                <bec-text-field
                                                  v-model="item.raw.claveDeBancoId"
...
export default defineComponent({
  ...
  setup() {
    ...
    const itemsAztecaInterbancario: AztecaInterbancario[] = [
      {
        id: 1,
        idCliente: 1,
        idEmpresa: 1,
        banco: 'Azteca Interbanacario',
        esActivo: true,

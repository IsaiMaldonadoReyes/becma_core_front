        ...
        <v-tooltip bottom color="primary" interactive location="bottom">
          <template v-slot:activator="{ props: tooltipProps }">
            <v-btn
              ...
              @click="onOpenModalLogInicidencia"
            >
...
import InicidenciaModalLog from '@/views/nominas/gape/IncidenciaModalLog.vue'
...
export default defineComponent({
  name: 'IncidenciaForm',
  components: { BecSelect, BecAutocomplete, BecTextField, prenominaTooltips, InicidenciaModalLog },
  setup() {
    // 1. Imports
    // 2. Props y Emits
    ...
    const onOpenModalLogInicidencia = (evento: string, items: object, titulo: string) => {
      console.log("Hola")
      if (titulo == 'Nuevo') {
        /*items = {

                    ...
                    <v-tabs-window-item value="tab04" eager>
                      <v-card>
                        <v-card-title color="primary"
                          >Datos sueldos y salarios</v-card-title
                        >
                        <v-divider></v-divider>
                        <v-card-text>
                          <v-row>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const itemsRegistroPatronalNomina = computed(
      () => registroPatronalStore.registroPatronal
    );

    const itemsEntidadFederativaNomina = computed(
      () => entidadFederativaStore.entidadFederativa
    );
    ...
    const cargarCatalogosPorEmpresa = async (data: any) => {
      await Promise.all([
        ...
        (dataModel.value.zonasalario =
          empresaNomStore.empresa[0]?.zonasalariogeneral ?? ""),
      ]);
    };

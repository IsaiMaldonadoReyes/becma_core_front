                                    ...
                                    <template #default>
                                      ...
                                      >
                                        <v-row>
                                          ...
                                          <v-col cols="11">
                                            fecha de ingreso del trabajador con el cliente, utilizada para determinar su antigüedad y calcular las prestaciones correspondientes conforme al tiempo de servicio.
                                          </v-col>
                                        </v-row>
                                        <v-divider class="border-opacity-50 my-2" />
                                        <v-row>

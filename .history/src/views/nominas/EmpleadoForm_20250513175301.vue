              ...
              <v-card>
                ...
                <v-card-text>
                  <v-row>
                    ...
                    <v-col cols="12" lg="6">
                      <v-col cols="4"><v-checkbox color="primary" label="Alta"></v-checkbox></v-col>
                      <v-col cols="4"><v-checkbox color="primary" label="Baja"></v-checkbox></v-col>

                      <v-checkbox color="primary" label="Modif.salario"></v-checkbox>
                    </v-col>
                  </v-row>
                </v-card-text>
              </v-card>

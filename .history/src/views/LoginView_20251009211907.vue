              ...
              <v-row ref="vrowBarraPrincipalRef">
                ...
                <v-col v-if="current === 2" cols="12">
                  <v-card-text class="text-medium-emphasis">
                    Dé clic en el botón del archivo que desee descargar de su factura. Puede obtener
                    el PDF, el XML, o el ZIP, que incluye ambos archivos en una sola carpeta.
                  </v-card-text>
                </v-col>
              </v-row>
        ...
        >
          ...
          >
            ...
            <template v-slot:opposite>
              <div :class="[current === i ? 'text-h5' : 'text-h5']" style="color: white">
                {{ step.title }}
              </div>
              <div v-if="current === i" class="text-body-2" style="color: #e1dde8">
                {{ step.subtitle }}
              </div>
            </template>
          </v-timeline-item>
    ...
    const steps: Step[] = [
      {
        ...
        title: '1. Ticket',
        subtitle:
          'Ingrese la información de su recibo de compra para continuar con el proceso de facturación. Capturé los datos tal como aparecen en su recibo de compra para evitar errores en la validación y continuar con el proceso de facturación.',

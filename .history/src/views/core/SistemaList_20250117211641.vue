        ...
        <v-card width="100%" variant="elevated" elevation="10" rounded="lg">
          ...
          >
            ...
            <template v-slot:bottom>
              <v-pagination v-model="page" :length="getPaginas" show-first-last-page></v-pagination>
            </template>
          </v-data-table>
        </v-card>
      </v-col>
...
export default defineComponent({
  ...
  setup() {
    ...
    const getPaginas = computed(() => Math.ceil(items.value.length / itemsPerPage.value))

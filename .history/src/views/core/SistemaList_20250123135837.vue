...
export default defineComponent({
  ...
  setup() {
    ...
    // DialogConfirmationSistema
    const dialogConfirmationSistema = ref({
      cuerpo: '',
      dialog: false,
      evento: '',
      icono: '',
    ...
    const onOpenDialogConfirmationSistema = (evento: string, items: object, titulo: string) => {
      dialogConfirmationSistema.value = {
        cuerpo: '',
        dialog: true,
        evento: 'onDelete',
        icono: 'alert',

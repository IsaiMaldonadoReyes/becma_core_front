          ...
          >
            ...
            <template v-slot:item.actions="{ item }">
              ...
              <v-divider
                ...
                vertical
              ></v-divider>
              <v-icon size="small" @click="onOpenDialogAction"> mdi-delete </v-icon>
            </template>
...
import DFSistema from '../../helpers/dialogForms/DialogSistema.vue'

export default defineComponent({
  name: 'SistemaListado',
  components: { DialogAction, DFSistema },

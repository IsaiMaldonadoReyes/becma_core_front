  ...
  setup() {
    ...
    function onOpenDialogAction(evento: string) {
      dialogPropiedades.value = {
        ...
        cuerpo: 'El registro se eliminó correctamente',
        ruta: 'correct',
        color: '#438701',
        velocidad: 1,
        componente: '',
    ...
    const onSaveSistema = (evento: Eventos) => {
      console.log(evento)
      methods[evento]()
    }
    ...
    const onClickYesDialogConfirmation = (evento: Eventos) => {
      methods[evento]()
    }
    ...
    const methods: Record<Eventos, () => void> = {
      onSave: () => {
        alert('Save new')
      },
      onEdit: () => {

              ...
              <v-tabs-window v-model="current" color="transparent">
                <v-tabs-window-item key="s1" value="s1" color="transparent">
                  ...
                  <v-card-actions class="justify-end">
                    <v-btn variant="tonal" :disabled="current === 0" @click="prev">
                      Anterior</v-btn
                    >
...
export default defineComponent({
  ...
  setup() {
    ...
    const currentAnimation = computed(
      () => animationMap[current.value] ?? animationMap.s1
    );
    ...
    const methods: Record<Eventos, (...args: any[]) => void> = {
      ...
      onDeleteIds: () => {
        ...
        let mensaje =
          "Esta acción eliminará los sistemas seleccionados. ¿Desea continuar?";

        ...
        <v-row justify="end">
          <v-col cols="12" md="9">
            ...
            >
              ...
              <!-- vrowSucursalRef -->
              <v-row ref="vrowSucursalRef" v-if="current == 1">
                <v-col cols="10" lg="11">
                  <bec-autocomplete
              ...
              <v-row ref="vdtiRecibosRef" :style="getRowTablaRecibosHeight" class="overflow-auto">
                <v-col cols="12">
                  <v-tabs-window v-model="current" color="transparent">
                    <!--Paso 1-->
                    <v-tabs-window-item key="s1" value="1" color="transparent">
                      <!-- vdtiRecibosRef -->
                    ...
                    <!--Paso 2-->
                    <v-tabs-window-item key="s2" value="2">
                      <!-- vrowTitulo2Ref -->

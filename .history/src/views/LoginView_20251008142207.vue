                              ...
                              >
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-card-account-details" />
                                      Ingrese su RFC
                                    </v-card-text>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese un correo electrónico al que desee recibir el PDF y XML de la facura.
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-card-text>
                                      ...
                                      Ingrese el nombre de la Número exterior de su domicilio fiscal
                                    </v-card-text>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-card-text>
                                      <v-icon class="mr-1" color="white" icon="mdi-alert" />

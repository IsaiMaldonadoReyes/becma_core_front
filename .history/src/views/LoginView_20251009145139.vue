                ...
                <v-col cols="12">
                  <v-tabs-window v-model="current" color="transparent">
                    ...
                    <v-tabs-window-item key="s3" value="s3" color="transparent">
                      <v-row :style="getRowTablaRecibosHeight" class="d-flex align-center justify-center overflow-auto">
                        <v-col cols="12" lg="4" class="d-flex align-center justify-center pa-2">
                          <v-btn

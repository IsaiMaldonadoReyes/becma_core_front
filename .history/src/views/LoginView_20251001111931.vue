                    ...
                    <template v-slot:default="{ items }">
                      <v-row>
                        <v-col v-for="item in items" key="title" cols="12" md="12">
                          <v-card
                            class="rounded-lg d-flex justify-center align-center my-2 mx-4 pa-2"
                            flat
                            min-height="60px"
                            color="#f0f0f0"
                            elevation="2"
                          >
                            <v-row>
                              <v-col cols="12" lg="4" class="d-flex align-center">01/10/2025</v-col>
                              <v-col cols="12" lg="4" class="d-flex align-center">0102030405</v-col>
                              <v-col cols="12" lg="3" class="d-flex align-center">$ 345.67</v-col>
                              <v-col

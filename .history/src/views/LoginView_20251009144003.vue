              ...
              <v-row ref="vrowBarraPrincipalRef">
                ...
                <v-col v-if="current === 2" cols="12">
                  <v-card-text class="text-medium-emphasis">
                    Dé clic en el botón del archivo que desee descargar de su factura.
                    Puede obtener el PDF para visualizar o imprimir el comprobante, el XML
                    para conservar el archivo fiscal válido ante el SAT, o el ZIP, que
                    incluye ambos archivos en un solo paquete para su comodidad.
                  </v-card-text>
                </v-col>
              </v-row>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Capture el RFC del contribuyente tal como aparece
                                        en su constancia fiscal para emitir la factura
                                        correctamente.
                                      </v-col>
                                    </v-row>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese la razón social tal como aparece en su
                                        constancia de situación fiscal para evitar errores
                                        en la factura.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2 mx-4" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese un correo electrónico válido donde se
                                        enviarán automáticamente los archivos PDF y XML de
                                        su factura una vez generada.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2 mx-4" />
                                    <v-row>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="py-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Puede ingresar una observación o comentario
                                        relacionado con su factura. Este campo es opcional
                                        y no afecta la emisión.
                                      </v-col>
                                    </v-row>
                                  </v-card>
                                </template>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese el código postal tal como aparece en su
                                        constancia de situación fiscal para validar
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese el Estado tal como aparece en su
                                        constancia de situación fiscal para asegurar que
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese la ciudad tal como aparece en su
                                        constancia de situación fiscal para asegurar la
                                        correcta emisión de la factura.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-row>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese el municipio tal como aparece en su
                                        constancia de situación fiscal para garantizar la
                                        correcta emisión de su factura.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-row>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese el nombre de la calle tal como aparece en
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese el número exterior indicado en su
                                        constancia de situación fiscal.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2" />
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Ingrese el número interior de su domicilio fiscal,
                                        si aplica, según su constancia de situación
                                        fiscal.
                                      </v-col>
                                    </v-row>
                                  </v-card>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Seleccione el uso de CFDI conforme a su constancia
                                        de situación fiscal. Este dato indica el motivo o
                                        finalidad por la cual se emite la factura.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-row>
                                ...
                                <template #tooltip>
                                  <v-card color="transparent" elevation="0" class="pa-3">
                                    <v-row>
                                      ...
                                      <v-col cols="11">
                                        Seleccione el régimen fiscal tal como aparece en
                                        su constancia de situación fiscal. Este dato
                                        identifica el tipo de contribuyente ante el SAT.
                                      </v-col>
                                    </v-row>
                                    <v-divider class="border-opacity-50 my-2" />
                                    <v-row>

                          ...
                          <v-row>
                            <v-col cols="12" class="pa-3">
                              <bec-text-field
                                ...
                                :tooltip="'<v-icon icon=\'mdi-calendar-clock\' size=\'14\' /> <span style=\'font-size: 10px\'> Fecha de creación: 02/04/2025 14:52:02</span><br />'"
                                :color="'#722B81'"
                              />
                            </v-col>
                            <v-col cols="12" class="pa-3">
                              <bec-text-field
                                ...
                                :tooltip="'<v-icon icon=\'mdi-calendar-clock\' size=\'14\' /><span style=\'font-size: 10px; font-weight: bold;\'> Fecha de creación: 02/04/2025 14:52:02</span><br />'"
                                :color="'#722B81'"
                              />
                            </v-col>
                          </v-row>

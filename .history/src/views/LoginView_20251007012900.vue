<template>
  <v-container ref="vconPrincipalRef" class="fill-height login-body" fluid>
                      ...
                      <v-tooltip bottom color="primary" interactive>
                        <template v-slot:activator="{ props: tooltipProps }">
                          <v-btn
                            ...
                            min-width="40px"
                            width="40px"
                            @click="onOpenDialogSistema('onSave', 'Recibo')"
                          >
    ...
    <kiosko-modal-form
      :dialog-event="modalFormPropiedades.evento"
...
export default defineComponent({
  ...
  setup() {
    ...
    const onSaveDialogSistema = (recibo: Recibo) => {
      itemsRecibos.value.push(recibo)
    }

    const onOpenDialogSistema = (evento: string, titulo: string) => {

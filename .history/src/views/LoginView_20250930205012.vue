  ...
  <v-container ref="vconPrincipalRef" class="fill-height login-body" fluid>
    ...
    <v-row>
      <v-img
        ...
        contain
        style="position: absolute; z-index: 1; width: 150px; left: 40%; transform: translateY(0px)"
      />
      <v-col v-if="smAndDown" cols="12" md="2" ref="vtimContenidoRef">
        ...
        >
          ...
          >
            ...
            <v-card
              class="d-flex align-center justify-enter text-center ma-0 pa-0"
              height="80px"
              color="#E6E6E6"
              elevation="16"
...
export default defineComponent({
  ...
  setup() {
    ...
    const getTimelineItemWidth = computed(() => {
      if (vcarContenidoRef.value) {
        const ancho = (vcarContenidoRef.value.$el.clientWidth - 200) / 3

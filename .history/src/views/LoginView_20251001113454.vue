                      ...
                      <v-row>
                        <v-col v-for="item in items" key="title" cols="12" md="12">
                          ...
                          >
                            <v-row>
                              <v-col cols="12" lg="4">
                                <v-card-title style="font-size: 10px; color: #722b81">
                                  Fecha
                                </v-card-title>
                              ...
                              <v-col cols="12" lg="3" class="">
                                <v-card-title class="d-flex justify-end" style="font-size: 10px; color: #722b81">
                                  Folio
                                </v-card-title>
                                <v-card-text class="d-flex justify-end">$ 345.67</v-card-text>
                              </v-col>

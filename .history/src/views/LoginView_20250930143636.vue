<template>
  <v-container ref="vconPrincipalRef" class="fill-height login-body" fluid>
    ...
    <v-row>
      ...
      <v-col v-if="smAndDown" cols="12" md="2" ref="vtimContenidoRef">
        ...
        >
          <v-timeline
            ...
            :style="{
              zIndex: 1,
              transform: smAndDown ? 'none' : 'translateX(0px)',
            }"
          >
            <v-timeline-item
            ...
            >
              <template v-slot:icon>
                <v-icon
                  ...
                  :icon="
                    i < current ? 'mdi-check' : i === current ? 'mdi-progress-clock' : step.icon
                  "
                ></v-icon>
              </template>

              <template v-slot:opposite>
                <div style="color: #722b81; font-size: 12px">
                  {{ step.title }}
                </div>
                <div class="text-body-2" style="color: #722b81; font-size: 10px"">
                  {{ step.subtitle }}
                </div>
              </template>
            </v-timeline-item>
                    ...
                    <template v-slot:default="{ items }">
                      <v-row>
                        <v-col v-for="item in items" key="title" cols="12" md="12">
                          ...
                          >
                            <v-row>
                              <v-col cols="12" lg="4">Sucursal</v-col>
                              <v-col cols="12" lg="4">Folio</v-col>
                              <v-col cols="12" lg="3">Monto</v-col>
                              <v-col class="d-flex justify-center align-center" cols="12" lg="1">
                                <!-- vbtnEliminar -->
                                <v-tooltip bottom color="primary" interactive>
                                  <template v-slot:activator="{ props: tooltipProps }">
                                    <v-btn
      ...
      <v-col cols="12" md="2" ref="vtimContenidoRef">
        <v-timeline
          align="center"
          class="pa-0 ma-0"
          direction="vertical"

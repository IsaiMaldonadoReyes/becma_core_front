    ...
    const steps: Step[] = [
      {
        ...
        title: '1. Ticket',
        subtitle:
          'Ingrese la información de su recibo de compra para continuar con el proceso de facturación. Asegúrese de capturar los datos tal como aparecen en el comprobante para evitar errores en la validación.',

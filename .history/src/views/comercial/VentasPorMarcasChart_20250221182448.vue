...
import { Chart, type ChartEvent, type ChartTypeRegistry } from 'chart.js/auto'
import { getRelativePosition } from 'chart.js/helpers' // Importa getRelativePosition
          ...
          const options = {
            ...
            onClick: (e: ChartEvent) => {
              if (chart) {
                ...
                console.log('Valor en X:', dataX)
                console.log('Valor en Y:', dataY)
              }
            },
          }

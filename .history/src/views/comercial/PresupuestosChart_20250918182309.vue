...
// import views
import PresupuestoModalForm from '@/views/comercial/PresupuestosModalForm.vue'
...
export default defineComponent({
  ...
  components: { Vue3Lottie, BecAutocomplete, BecSelect, PresupuestoModalForm },
  ...
  setup() {
    ...
    const onOpenDialogPresupuestos = (evento: string, items: object, titulo: string) => {

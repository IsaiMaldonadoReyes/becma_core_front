<template>
  <v-container fluid ref="vconPrincipalRef" class="h-100">
    ...
    <v-row ref="vtabGraficaRef">
      <v-col class="my-0 py-0">
        <v-tabs v-model="vtabGraficaSelected" color="primary" class="text-medium-emphasis" density="compact">
          <v-tab v-for="tab in vtabGraficaItems" :key="tab.value" :value="tab.value" :variant="vtabGraficaSelected == tab.value ? 'tonal' : 'text'">

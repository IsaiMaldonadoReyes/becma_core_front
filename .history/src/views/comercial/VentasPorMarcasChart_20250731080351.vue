      ...
      <v-col>
        <v-card class="pa-5 overflow-auto" :style="getRowContenidoHeight">
          <v-tabs-window v-model="vtabMenuModel">
            ...
            >
              <canvas
                v-if="chartHasData(chartInstances[tab.chartInstance])"
                :ref="tab.chart"
                :style="getChartHeight"
              ></canvas>
              <!--div
...
export default defineComponent({
  ...
  setup() {
    ...
    let chartInstanceV: Chart | undefined
    let chartInstanceH: Chart | undefined
    let chartInstanceLineal: Chart | undefined
    ...
    const chartHasData = (chart: Chart | undefined): boolean => {
      return (
        !!chart &&
        chart.data.datasets.length > 0 &&
        chart.data.datasets.some((ds) => Array.isArray(ds.data) && ds.data.length > 0)
      )
    }

...
export default defineComponent({
  ...
  setup() {
    ...
    const vtabGraficaItems = ref([
      {
        ...
        title: 'Barras',
        value: 'tabBarrasV',
        chart: 'canvasChartBarrasV',
        chartInstance: 'chartInstanceV',
      },
      {
        icon: 'mdi-chart-gantt',
        title: 'Horizontal',
        value: 'tabBarrasH',
        chart: 'canvasChartBarrasH',
        chartInstance: 'chartInstanceH',
      },
      {
        icon: 'mdi-chart-line',
        title: 'Lineal',
        value: 'tabLineal',
        chart: 'canvasChartLineal',
        chartInstance: 'chartInstanceLineal',
      },
    ])
    ...
    // Chart Js
    const canvasChartBarrasV = ref<HTMLCanvasElement | null>(null)
    const canvasChartBarrasH = ref<HTMLCanvasElement | null>(null)
    const canvasChartLineal = ref<HTMLCanvasElement | null>(null)
    ...
    const chartDataReadyMap = ref<Record<string, boolean>>({
      canvasChartBarrasV: false,
      canvasChartBarrasH: false,
      canvasChartLineal: false,
    })
    ...
    onMounted(() => {
      nextTick(() => {
        if (canvasChartBarrasV.value) {
          chartInstanceV = new Chart(canvasChartBarrasV.value, {
            type: 'bar',
        ...
        if (canvasChartBarrasH.value) {
          chartInstanceH = new Chart(canvasChartBarrasH.value, {
            type: 'bar',
            data: chartData.value,
        ...
        if (canvasChartLineal.value) {
          chartInstanceLineal = new Chart(canvasChartLineal.value, {
            type: 'line',
            data: chartData.value,
        ...
        if (chartInstanceV) chartInstances.canvasChartBarrasV = chartInstanceV
        if (chartInstanceH) chartInstances.canvasChartBarrasH = chartInstanceH
        if (chartInstanceLineal) chartInstances.canvasChartLineal = chartInstanceLineal
    ...
    const fetchChartData = async () => {
      ...
      if (isValidForm.valid) {
        ...
        chartDataReadyMap.value.canvasChartBarrasV = false
        chartDataReadyMap.value.canvasChartBarrasH = false
        chartDataReadyMap.value.canvasChartLineal = false
        ...
        try {
          ...
          chartInstanceV.update()
          chartDataReadyMap.value.canvasChartBarrasV = true

          chartInstanceH.update()
          chartDataReadyMap.value.canvasChartBarrasH = true

          chartInstanceLineal.update()
          chartDataReadyMap.value.canvasChartLineal = true
        } catch (error) {
        } finally {
        }
      }

  ...
  <v-container>
    ...
    <v-row dense>
      <v-col cols="12" lg="6" class="d-flex align-center">
        <v-breadcrumbs :items="vbrePrincipalItems" divider="|" class="ma-0 pa-0">
          <template v-slot:prepend>
            <v-icon icon="mdi-chart-bar" color="primary" />
          </template>
        </v-breadcrumbs>
      </v-col>
      <v-col lg="6" class="d-flex align-end justify-start justify-lg-end">
        <v-tooltip bottom color="primary">
          <template v-slot:activator="{ on, attrs }">
            ...
            <v-btn
              ...
              @click="exportToExcel()"
            >
              <v-icon size="30px" color="white">mdi-microsoft-excel</v-icon>
            </v-btn>
          </template>
        ...
        <v-tooltip bottom color="primary">
          <template v-slot:activator="{ on, attrs }">
            ...
            >
              <v-icon size="30px" color="white">mdi-file-pdf-box</v-icon>
            </v-btn>
          </template>

<template>
  <v-container>
    <v-navigation-drawer v-model="drawer" location="right" :width="350" class="border-0">
      <v-card class="ma-5" elevation="10" height="calc(100% - 40px)">
    ...
    <v-row dense>
      <v-col>
        <v-breadcrumbs :items="vbrePrincipalItems" divider="|" large>

  ...
  setup() {
    ...
    const fetchEmpresas = async () => {
      try {
        ...
        itemsEmpresas.value = reporte.respuesta.data
      } catch (error) {
      } finally {
      }
    }
    ...
    const fetchEjercicios = async () => {
      ...
      try {
        ...
        itemsEjercicios.value = reporte.respuesta.data
      } catch (error) {
    ...
    const fetchMarcas = async () => {
      ...
      try {
        ...
        itemsMarcas.value = reporte.respuesta.data
      } catch (error) {
        console.error('Error al cargar ejercicio:', error)
      } finally {
      }
    ...
    const fetchAgentes = async () => {
      ...
      try {
        ...
        await reporte.storeMarcas(data)
        itemsAgentes.value = reporte.respuesta.data
      } catch (error) {
        console.error('Error al cargar ejercicio:', error)
      } finally {
      }

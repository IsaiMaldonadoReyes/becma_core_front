    ...
    const optionsChartBarV: ChartOptions = {
      ...
      onClick: (e, elements, chart) => {
        if (elements.length > 0) {
          ...
          let formDataPresupuesto = new FormData();
          formDataReq.append("idEmpresa", this.empresaR5);
        formDataReq.append("mes", valorMes);
        formDataReq.append("ejercicio", ejercicioSelecionado.CEJERCICIO);
        formDataReq.append("idAgente", this.agenteR5 ?? "");
        formDataReq.append("idEjercicio", this.ejercicioR5);
        formDataReq.append("marca", valorMarca);

          onOpenDialogPresupuestosChart('', [], [])
          //0000dialogPresupuestosChartPropiedades.value.dialog = true

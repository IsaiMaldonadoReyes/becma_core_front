<template>
  <v-container class="d-flex align-center justify-center fill-height login-body" fluid>
    ...
    <v-card color="#1E2022" elevation="16" width="55%" class="rainbow">
      <v-row>
        <v-col cols="12" lg="6">
          <v-card color="#1E2022" elevation="0">
            <vue3-lottie
              width="90%"
              :animation-link="'/src/assets/images/animacion.json'"
            />
          </v-card>
        </v-col>
...
.rainbow {
  ...
  &::before {
    ...
    background: conic-gradient(
      #fd720d 0deg 60deg,
      #a1c500 60deg 120deg,
      #fd073c 120deg 180deg,
      #fea406 180deg 240deg,
      #fc4d26 240deg 300deg,
      #018dc9 300deg 360deg
    );

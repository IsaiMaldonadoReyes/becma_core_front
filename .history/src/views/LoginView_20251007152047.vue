            ...
            >
              <v-tabs-window v-model="current" color="transparent">
                ...
                <v-tabs-window-item key="s2" value="s2">
                  ...
                  <!-- vrowTabDatosFiscales -->
                  <v-row ref="vrowTabDatosFiscales">
                    <v-col>
                      <v-tabs
                  ...
                  <!-- vtabFormDatosFiscalesRef -->
                  <v-row
                    ref="vtabFormDatosFiscalesRef"
                    :style="getRowFormularioDatosFiscalesHeight"
                    class="overflow-auto"
                  >
                    <v-tabs-window v-model="vtabMenuModel">
                      <v-tabs-window-item value="tabBarV">
                        <v-row>
                      ...
                      <v-tabs-window-item value="tabBarH">
                        <v-row>
                          ...
                          <v-col cols="6" class="pa-3" style="z-index: 3">
                            <bec-text-field
                              v-model="modelEmpresa"
                  ...
                  <v-card-actions ref="vactFoot2Ref" class="justify-end">
                    <v-btn
                      border
                      class="text-none mr-2"
                      color="#722B81"
...
export default defineComponent({
  ...
  setup() {
    ...
    const vrowTitulo2Ref = ref()
    const vrowTabDatosFiscales = ref()
    const vtabFormDatosFiscalesRef = ref()
    const vactFoot2Ref = ref()
    ...
    const getRowTablaRecibosHeight = computed(() => {
      if (
        !vconPrincipalRef.value ||
        vrowTituloRef.value ||
        vrowSucursalRef.value ||
        vactFootRef.value ||
        vtabMenuModel.value !== 'tabBarV'
      ) {
        let alto = 0
        alto =
    ...
    const getRowFormularioDatosFiscalesHeight = computed(() => {
      if (
        vconPrincipalRef.value ||
        vrowTitulo2Ref.value ||
        vrowTabDatosFiscales.value ||
        vactFoot2Ref.value ||
        vtabMenuModel.value !== 'tabBarH'
      ) {
        let alto = 0
        alto =
          vconPrincipalRef.value.$el.clientHeight * 0.8 -

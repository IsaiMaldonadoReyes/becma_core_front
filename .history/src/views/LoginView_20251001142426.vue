                        ...
                        <v-col v-for="item in items" key="title" cols="12" md="12">
                          ...
                          >
                            ...
                            <v-row v-else>
                              <v-col
                                cols="6"
                                style="font-size: 14px; color: #722b81; font-weight: bold"
                              >
                                Fecha
                              </v-col>
                              <v-col cols="6">01/10/2025</v-col>
                              <v-col cols="6">Folio</v-col>
                              <v-col cols="6">52222054</v-col>
                              <v-divider></v-divider>

                              <v-col cols="6" >Total</v-col>
                              <v-col cols="6" style="font-size: 14px; color: #722b81; font-weight: bold">52222054</v-col>
                            </v-row>
                          </v-card>
                        </v-col>
                      </v-row>

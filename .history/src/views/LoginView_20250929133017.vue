  ...
  <v-container ref="vconPrincipalRef" class="fill-height login-body" fluid>
    ...
    <v-row>
      <v-img
        ...
        "
      />
      <v-col lg="9" class="d-flex align-center justify-end" ref="vcarContenidoRef">
        <vue3-lottie
          width="400px"
          height="400px"
            ...
            >
              <v-tabs-window v-model="current" color="transparent">
                ...
                <v-tabs-window-item key="s1" value="s1" color="transparent">
                  ...
                  <v-row>
                    <v-col>
                      <v-divider class="border-opacity-50 mt-3" />
                    </v-col>
                  </v-row>
  ...
  setup() {
    ...
    const getRowTablaRecibosHeight = computed(() => {
      ...
      if (vrowTituloRef.value) {
        alto.value = vcarContenidoRef.value.$el.clientHeight * 0.55
      }

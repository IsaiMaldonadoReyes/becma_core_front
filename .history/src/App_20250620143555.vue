  ...
  <v-app>
    ...
    <v-footer app>
      <v-card flat tile width="100%" class="bg-surface-light">
        <v-card-text
          class="grey--text text--darken-3 d-flex align-end justify-center"
          width="100px"
        >
          <v-img src="/src/assets/images/becma_logo_color.png" height="25" width="25" />
  ...
  setup() {
    ...
    const logoSrc = computed(() => {
      return theme.global.current.value.dark
        ? "/src/assets/images/becma_logo_dark.png"

  ...
  <v-app>
    <v-app-bar app clipped-left height="60">
      ...
      <navigation-drawer
        ...
        :rail-children="navigationDrawerProps.railPadre"
        :rail-parent="navigationDrawerProps.railHijo"
      ></navigation-drawer>

      <v-menu bottom :close-on-content-click="false" min-width="350px" offset-y right />
